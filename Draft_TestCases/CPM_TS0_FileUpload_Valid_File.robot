...
#Check Copyright Year in CPM
    Wait until Element Is Visible   xpath://*[@id="header"]/div/header/div[2]/span[1]
    ${cpmyearprint}     Set Variable    xpath://*[@id="undefined"]/footer/div/div[3]/ul/li[1]
    Element Text Should Be      xpath://*[@id="undefined"]/footer/div/div[3]/ul/li[1]    ${cpmyear}
...
#Check Delegates Tab opens and check Text
    ...
    Element Should Contain  xpath://*[@id="delegatesPageHeaderDropDown_button"]/div   ${tab2name}

#Check Print Job History Tab opens and check Text
    Wait until Element Is Visible   id:link-navJobHistory
    Click Element   id:link-navJobHistory
    Wait until Element Is Visible   xpath://*[@id="printHistoryPageHeader"]/div[1]/h2
    Element Should Contain  xpath://*[@id="printHistoryPageHeader"]/div[1]/h2   ${tab3name}
...
#Check Client Download Tab opens and check Text
    ...
    Element Should Contain  xpath://*[@id="clientDownloadPageHeader"]/div[1]/h2   ${tab4name}
    Click Element   id:link-navPrintQueue
    sleep_call_2
