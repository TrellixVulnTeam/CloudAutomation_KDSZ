...
#def user_quota_status():
    ...
    #url="https://apis."+setup+"."+locale+".cloud.onelxk.co"
    #print(url)
    conn = http.client.HTTPSConnection("apis."+setup+"."+locale+".cloud.onelxk.co")
...
# #create_user_all("sravantesh.neogi@lexmark.com","Password@1234","https://dev.us.cloud.onelxk.co","cpmautomation@test.onelxk.co")
#
# quota_green_all("sravantesh.neogi@lexmark.com","Password@1234","https://dev.us.cloud.onelxk.co")
#
# quota_yellow_all("sravantesh.neogi@lexmark.com","Password@1234","https://dev.us.cloud.onelxk.co")
#
# quota_red_all("sravantesh.neogi@lexmark.com","Password@1234","https://dev.us.cloud.onelxk.co")

#delete_user_all("sravantesh.neogi@lexmark.com","Password@1234","https://dev.us.cloud.onelxk.co","cpmautomation@test.onelxk.co")